    ...
    bot.on("message", async (msg: any) => {
        ...
        if (text.match(regex)) {
            ...
            if (typeof boxFound === "string") {
                ...
                boxMessage = `Мы нашли подходящую вам коробку. \nЕе размеры ${boxFound.size} см. \n\nЦена коробки из крафтового картона ${boxFound.priceCraft} рублей, \nиз цветного картиона ${boxFound.priceColor} рублей.`;
            }
            return bot.sendMessage(chatId, boxMessage);
        } else {
            switch (text) {
                case "/start": {
